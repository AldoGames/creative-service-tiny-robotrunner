...
namespace Unity.Tiny.Extensions
{
    ...
    public static class IRegistryCoreTypeExtensions
    {
        ...
        public static UTinyType.Reference GetCamera2DAxisSortType(this IRegistry registry)
        {
            return registry.GetType("UTiny.Core2D.Camera2DAxisSort");
        }
        ...
        public static UTinyType.Reference GetSprite2DRendererOptionsType(this IRegistry registry)
        {
            return registry.GetType("UTiny.Core2D.Sprite2DRendererOptions");
        }

        public static UTinyType.Reference GetSprite2DBorderType(this IRegistry registry)
        {
            return registry.GetType("UTiny.Core2D.Sprite2DBorder");
        }
        ...
        public static UTinyType.Reference GetSortingGroupType(this IRegistry registry)
        {
            return registry.GetType("UTiny.Core2D.SortingGroup");
        }

        public static UTinyType.Reference GetExtraSortingType(this IRegistry registry)
        {
            return registry.GetType("UTiny.Core2D.LayerSorting");
        }
