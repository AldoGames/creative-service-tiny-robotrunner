...
namespace Unity.Tiny
{
    ...
    public interface IFieldTypeUpdater
    {
        object UpdateField(UTinyField field, object value);
    }
    ...
    public static class UTinyUpdater
    {
        ...
        private static readonly Dictionary<UTinyId, IFieldTypeUpdater> s_FieldTypeUpdaters = new Dictionary<UTinyId, IFieldTypeUpdater>();
        ...
        public static void Register(UTinyId id, IFieldTypeUpdater typeUpdater)
        {
            Assert.IsFalse(s_FieldTypeUpdaters.ContainsKey(id));
            s_FieldTypeUpdaters.Add(id, typeUpdater);
        }
        ...
        public static object UpdateFieldType(UTinyField field, object value)
        {
            if (!s_FieldTypeUpdaters.ContainsKey(field.FieldType.Id))
            {
                return value;
            }

            return s_FieldTypeUpdaters[field.FieldType.Id].UpdateField(field, value);
        }
    ...
    public class CharToIntTypeUpdater : IFieldTypeUpdater
    {
