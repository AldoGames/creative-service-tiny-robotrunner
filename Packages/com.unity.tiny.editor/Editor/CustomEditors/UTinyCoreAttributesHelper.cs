...
namespace Unity.Tiny
{
    public static class UTinyCoreAttributesHelper
    {
        ...
        private static Dictionary<UTinyId, List<AttributeBinder>> s_Lookup = new Dictionary<UTinyId, List<AttributeBinder>>()
        {
            ...
            { UTinyId.Generate("UTiny.Core2D.Sprite2DRendererOptions"), new List<AttributeBinder> { (r, t) => AddBindings(r, t, type => new Sprite2DRendererOptionsBindings(type)) } },
            ...
            { UTinyId.Generate("UTiny.Core2D.Camera2DAxisSort"), new List<AttributeBinder> { (r, t) => AddBindings(r, t, type => new Camera2DAxisSortBindings(type)) } },
            ...
            { UTinyId.Generate("UTiny.Core2D.SortingGroup"), new List<AttributeBinder> { (r, t) => AddBindings(r, t, type => new SortingGroupBindings(type)) } },
            { UTinyId.Generate("UTiny.Core2D.LayerSorting"), new List<AttributeBinder> { AddEditor<SortingLayerEditor>, (r, t) => AddBindings(r, t, type => new SortingLayerBindings(type)) } },
            /* basic Math types */
