...
namespace Unity.Tiny
{
    ...
    /// </summary>
    [AutoRepaintOnTypeChange(typeof(UTinyEntityGroup))]
    [AutoRepaintOnTypeChange(typeof(UTinyType))]
    [AutoRepaintOnTypeChange(typeof(UTinySystem))]
    [AutoRepaintOnTypeChange(typeof(UTinyModule))]
    public class UTinyProjectWindow : EditorWindow
    {
        ...
        private void Update()
        {
            if (null == UTinyEditorApplication.Project)
            {
                return;
            }
